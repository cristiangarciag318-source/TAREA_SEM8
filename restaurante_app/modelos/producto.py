class Producto:
    ...
    def _validar_categoria(categoria: str) -> str:
        categorias_validas = ("entradas", "platos fuertes", "postres", "bebidas", "acompanantes")
        ...
        if categoria_limpia not in categorias_validas:
            ...
            raise ValueError(f"Categoria no reconocida. Opciones: {opciones}.")
        return categoria_limpia.capitalize()
